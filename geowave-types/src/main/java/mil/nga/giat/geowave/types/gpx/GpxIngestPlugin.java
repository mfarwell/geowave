		...
		StageToHdfsPlugin<GpxTrack>
{
	...
	private Map<String, Map<String, String>> getAdditionalData(
		...
		if (gpxTrack.getTrackid() != null) dataSet.put(
				"TrackId",
				gpxTrack.getTrackid().toString());
		if (gpxTrack.getUserid() != null) dataSet.put(
				"UserId",
				gpxTrack.getUserid().toString());
		if (gpxTrack.getUser() != null) dataSet.put(
				"User",
				gpxTrack.getUser().toString());
		if (gpxTrack.getDescription() != null) dataSet.put(
				"Description",
